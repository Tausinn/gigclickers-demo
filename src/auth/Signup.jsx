  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-green-400 via-green-200 to-blue-400 flex items-center justify-center">
      ...
      <div className="backdrop-blur-lg bg-white/30 p-8 rounded-xl shadow-xl w-full max-w-md mx-auto">
        {/* Form Title */}
        <h2 className="text-3xl font-bold text-center text-green-700 mb-8">Free Jobs Register</h2>
        ...
        <form className="space-y-6">
          ...
          <div className="relative">
            ...
            <input
              ...
              required
            />
  <label htmlFor="password" className="block text-sm font-medium text-green-800">Confirm Password</label>
            <input
              type={showPassword ? "text" : "password"}
              id="confirmPassword"
              className="w-full p-3 mt-1 bg-white border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:outline-none"
        ...
        {/* Footer Text */}
        <p className="text-center text-sm text-gray-500 mt-8">Already have an account? <Link to="/login" className="text-green-700 hover:underline">Login up here</Link></p>
      </div>
    </div>
  );
};
